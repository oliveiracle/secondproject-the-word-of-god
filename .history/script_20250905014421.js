...
randomVerseButton.addEventListener('click', () => {
    ...
    // Espera o documento inteiro ser carregado para rodar o código
        document.addEventListener('DOMContentLoaded', function() {

            // 1. Pega os elementos que vamos usar
            const botaoSentimento = document.getElementById('feeling-btn');
            const luzDivina = document.getElementById('luz-divina');

            // 2. Cria um "ouvinte" que espera pelo clique no botão
            botaoSentimento.addEventListener('click', function() {
                
                // 3. Quando o botão for clicado, adiciona a classe 'acesa' ao elemento da luz
                luzDivina.classList.add('acesa');
            });
        });