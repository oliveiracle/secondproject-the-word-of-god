    ...
    button.addEventListener('click', () => {
        ...
        if (verseArray) {
            ...
            verseArray.forEach((verse, index) => {
                ...
                typeOutVerse(verse, verseParagraph, index);
            });
        } else {
            // If we don't find any verses, show an error message.
            verseDisplay.innerText = "Sorry, I could not find a verse for this feeling.";
        }
        
        // 5. Smoothly scroll to the verse box so the user can see it.
        setTimeout(() => {
...
// ===================================================================================
//  4. THE TYPING EFFECT FUNCTION
// ===================================================================================
// A function that types out a given text into a given element, with a delay.

function typeOutVerse(text, element, index) {
    let i = 0;
    const speed = 50; // Typing speed in milliseconds.
    const delayBetweenVerses = 4000; // 4 seconds delay between each verse starting to type.

    // The initial delay is calculated based on the verse's position in the list (its index).
    const initialDelay = index * delayBetweenVerses;
