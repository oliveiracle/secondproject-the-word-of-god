...
randomVerseButton.addEventListener('click', () => {
    ...
    // ========================================= 
// JAVASCRIPT SIMPLIFICADO PARA EFEITO DE LUZ
// ========================================= 

// Função para criar o efeito de luz divina
function createDivineLightEffect() {
    const lightContainer = document.getElementById('divine-light');
    const lightBeam = document.getElementById('light-beam');
    const particlesContainer = document.getElementById('particles-container');
    
    if (!lightContainer) {
        console.log('Container de luz não encontrado');
        return;
    }
    ...
    // Mostrar o container e ativar animações
...
document.addEventListener('DOMContentLoaded', function() {
    ...
    if (feelingBtn) {
        feelingBtn.addEventListener('click', function() {
            console.log('Botão clicado - iniciando efeito de luz');
            createDivineLightEffect();
        });
    } else {
        console.log('Botão feeling-btn não encontrado');
    }
});
