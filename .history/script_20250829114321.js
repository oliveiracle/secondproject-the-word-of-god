    ...
    button.addEventListener('click', () => {
        ...
        if (verseArray) {
            ...
            verseArray.forEach((verse, index) => {
                ...
                // Chama a função que digita o texto
...
function typeVerse(text, element, delayIndex) {
    // Atraso inicial para cada versículo
    const initialDelay = delayIndex * 1500; // Atraso de 1.5 segundo entre os versículos
    
    // Atraso para cada letra
    const letterDelay = 20; // 20 milissegundos por letra
