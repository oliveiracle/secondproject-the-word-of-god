...
randomVerseButton.addEventListener('click', () => {
    ...
    // ========================================= 
// FUNÇÃO SIMPLES PARA LIGAR/DESLIGAR LUZ
// ========================================= 

// Adicione esta função no seu script.js
function toggleDivineLight() {
    const lightContainer = document.getElementById('divine-light');
    
    if (lightContainer) {
        // Verifica se a luz está acesa ou apagada
        if (lightContainer.classList.contains('light-on')) {
            // Se está acesa, apaga
            lightContainer.classList.remove('light-on');
            console.log('Luz apagada');
        } else {
            // Se está apagada, acende
