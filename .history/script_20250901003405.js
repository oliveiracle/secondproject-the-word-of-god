// ===================================================================================
//  1. GET HTML ELEMENTS (that exist when the page loads)
// ===================================================================================
...
// --- What happens when the MAIN BUTTON ("How are you feeling...") is clicked ---
...
// ===================================================================================
//  4. PRAYER FORM LOGIC (DYNAMICALLY CREATED)
// ===================================================================================

// --- This function builds and shows the form ---
function showPrayerForm() {
    if (document.getElementById('prayer-modal')) {
        return; // Stop if the form already exists
    }

    const modalOverlay = document.createElement('div');
    modalOverlay.id = 'prayer-modal';
    ...
    title.innerText = 'Request a Prayer';

    const instruction = document.createElement('p');
    instruction.innerText = 'Your request will be received with care. God bless you.';

    const textArea = document.createElement('textarea');
    textArea.id = 'prayer-request-text';
    textArea.placeholder = 'You can write your prayer here...';

    const submitBtn = document.createElement('button');
    submitBtn.id = 'submit-prayer-btn';
    submitBtn.innerText = 'Send Prayer';
    ...
    // --- Add logic to the NEW buttons we just created ---
    ...
    submitBtn.addEventListener('click', () => {
        const prayerText = textArea.value;
        if (prayerText.trim() !== '') {
...
// --- Tell the main prayer button to run our function on click ---
prayerButton.addEventListener('click', showPrayerForm);