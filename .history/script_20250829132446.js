...
startButton.addEventListener('click', () => {
    ...
    verseDisplay.style.display = 'none'; // Esconde completamente a área de versículos
});
//
startButton.addEventListener('click', () => {
    startButton.style.transform = 'scale(1.2)'; // Aumenta o tamanho
    startButton.style.transition = 'transform 6s'; // Faz a animação durar 0.3 segundos
});

//
feelingsContainer.addEventListener('click', () => {
    feelingsContainer.style.transform = 'scale(1.2)'; // Aumenta o tamanho
    feelingsContainer.style.transition = 'transform 6s'; // Faz a animação durar 0.3 segundos
});
...
feelingButtons.forEach(button => {
    button.addEventListener('click', () => {
        // Torna a caixa de versículos visível antes de começar
...
// Allow user to set typing speed for accessibility
let userLetterDelay = 60; // Default to 60ms per character

// Optionally, create a UI control for speed (e.g., a range input)
