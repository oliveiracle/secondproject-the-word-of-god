...
startButton.addEventListener('click', () => {
    ...
    // Check if the feeling buttons container is currently visible or hidden
...
randomVerseButton.addEventListener('click', () => {
    ...
    // ========================================= 
// JAVASCRIPT PARA EFEITO DE LUZ AMARELA
// ========================================= 

// Função para criar o efeito de luz divina
function createDivineLightEffect() {
    // Verificar se já existe um container de luz ativo
    const existingLight = document.querySelector('.divine-light-container');
    if (existingLight) {
        return; // Evita múltiplas sobreposições
    }

    // Criar container principal do efeito
    const lightContainer = document.createElement('div');
    lightContainer.className = 'divine-light-container';

    // Criar o brilho de fundo
    const glow = document.createElement('div');
    glow.className = 'divine-glow';
    lightContainer.appendChild(glow);

    // Criar o feixe de luz principal
    const lightBeam = document.createElement('div');
    lightBeam.className = 'divine-light-beam';
    ...
    // Gerar partículas douradas aleatórias
    for (let i = 0; i < 25; i++) {
    ...
    lightContainer.appendChild(particlesContainer);
    ...
    setTimeout(() => {
        ...
        lightBeam.style.animation = 'divineLightBeam 3s ease-out forwards';
    }, 50);
...
document.addEventListener('DOMContentLoaded', function() {
    ...
    if (feelingBtn) {
        // Adicionar o efeito de luz ao clique existente
        feelingBtn.addEventListener('click', function() {
            // Criar o efeito de luz
            createDivineLightEffect();
        });
    }
});

// Função alternativa caso você queira chamar manualmente
